with individuals as (
    select distinct individual_id, deal_id, compartment from curated_wallet_item where individual_id = /*replace :individual_id */ '201446dcf52ae8b1480f' /*=endreplace */ and deal_id = /*replace :deal_id */ 'deal_1005' /*=endreplace */ and fund in /*=replace :euro_fund */ ('EURGENERALI1') /*=endreplace */
), quantity as (
    ...
    where curated_wallet_item.fund in /*=replace :euro_fund */ ('EURGENERALI1') /*=endreplace */  and curated_wallet_item.created_date < /*=replace :start_date */ date '2021-11-06'/*=endreplace */
    ...
    select individuals.individual_id,
        ...
        group by individuals.individual_id, individuals.deal_id, individuals.compartment
        order by max(curated_wallet_item.created_date) ASC
), guarantee AS (
